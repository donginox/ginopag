// Ensure the Supabase library is loaded before this script
// If using a CDN, include it in your HTML like this:
// <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script>

// Initialize Supabase client
const { createClient } = supabase; // Assuming supabase is globally available from the CDN
const supabaseClient = createClient(
  'https://fsmpgzystzedgwrinukb.supabase.co',
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZzbXBnenlzdHplZGd3cmludWtiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQ5MTk2ODksImV4cCI6MjA3MDQ5NTY4OX0.6bXgSLXvqKRt7T5yt-togXQQX4fbW-zk0z-4PRHt2yg'
);

// Example query to fetch news from Supabase
async function getNews() {
  try {
    const { data, error } = await supabaseClient
      .from('news') // Ensure this table exists in your Supabase database
      .select('*');
